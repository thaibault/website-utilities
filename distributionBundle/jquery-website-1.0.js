...
(function() {
  ...
  if (this.require != null) {
    ...
    this.require([['less.Parser', 'less-2.4.0'], ['jQuery.Tools', 'jquery-tools-1.0.coffee'], ['jQuery.scrollTo', 'jquery-scrollTo-2.1.0'], ['jQuery.fn.spin', 'jquery-spin-2.0.1'], ['jQuery.fn.hashchange', 'jquery-observeHashChange-1.0'], ['jQuery.Lang', 'jquery-lang-1.0.coffee']], main);
  } else {
